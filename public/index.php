...
<head>
    ...
    <title>Our Blog | Latest News & Updates</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="flex-shrink-0 flex items-center gap-2">
                    <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9.5a2 2 0 00-2-2h-2"></path></svg>
                    <a href="index.php" class="font-bold text-2xl tracking-tight text-gray-900">Client<span class="text-blue-600">Brand</span></a>
                </div>
                <div>
    ...
    <header class="bg-white border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
            <h1 class="text-5xl font-extrabold text-gray-900 tracking-tight mb-4">
                Latest <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">News & Insights</span>
            </h1>
            <p class="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
                Stay up to date with our latest announcements, industry insights, and feature updates.
            </p>
        </div>
    </header>
    ...
    <footer class="bg-white border-t border-gray-200 mt-auto">
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 flex justify-center">
            <p class="text-gray-500 text-sm text-center">
                &copy; <?php echo date('Y'); ?> ClientBrand. All rights reserved.
            </p>
        </div>
    </footer>
