...
<body class="bg-gray-50 text-gray-800">
    ...
    <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8 shadow-sm fixed w-full top-0 z-50">
        ...
        <div>
            <button onclick="savePost()" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-lg shadow-sm transition-all flex items-center gap-2">
